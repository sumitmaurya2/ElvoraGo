    ...
    <section id="home" className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-20 pb-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            We Build Smart{" "}
            <span className="text-gradient-primary">Web, Backend</span>
            {" & "}
          ...
          >
            From modern websites and secure APIs to AI-powered tools and startup consulting —
          ...
          >
            ...
            <Button variant="hero-outline" size="xl" onClick={() => scrollTo("#services")}>
              View Our Services
            </Button>
          </motion.div>
