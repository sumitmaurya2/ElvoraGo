...
const coreValues = [
  ...
  },
  {
    ...
    description:
      "We stay ahead with the latest technologies and practices.",
  },
  {
    icon: Heart,
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <AnimatedSection>
          ...
          dark:bg-white/5 dark:border-emerald-900/30 dark:shadow-none">
            ...
            <p className="mt-6 text-lg md:text-2xl font-medium leading-relaxed
            text-stone-700 dark:text-stone-200">
              Our mission is to{" "}
              ...
              into intuitive, future-ready solutions.
            </p>
          </div>
        </AnimatedSection>
